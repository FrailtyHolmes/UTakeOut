...
public class AutoFillAspect {
    ...
    public void autoFill(JoinPoint joinPoint) {
        ...
        //void com.sky.mapper.CategoryMapper.update/insert(Category)
        //获得当前方法上的注解对象
        ...
        // 获取参加Insert或者Update的参数， Employee或者Category等，
        // 这里将需要参加的这些参数全部写在第一位，保证args[0]获得的参数是实体对象
