...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        //调用微信支付接口，生成预支付交易单,此项目暂时未实现支付功能，故选择直接跳过此功能
...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public void repetition(Long id) {
        ...
        List<ShoppingCart> shoppingCartList = orderDetailList.stream().map(x -> {
            ...
            // 将原订单详情里面的菜品信息重新复制到购物车对象中,id不复制
...
//                    new BigDecimal(0.01),
//                    new BigDecimal(0.01));
            String refund = ordersDB.getId() + " 退款:" + ordersDB.getAmount();
...
//                    new BigDecimal(0.01));
    ...
    private String getOrderDishStr(Orders orders) {
        ...
        // 将该订单对应的所有菜品信息拼接在一起
        //如果直接转String : [来凤鱼*1;, 馒头*1;, 米饭*1;, jj*2;]
        //需要添加String.join()，指定分隔符为空
